                ...
                <div style={{marginRight:"20px"}}>
                    <nav>
                        <ul style={{display:"flex"}}>
                            ...
                            <li style={{listStyle:"none",padding:"5px 20px 0px 20px"}}><Link style={{color:"yellow"}} to={`/about`}>About</Link></li>
                            <li style={{listStyle:"none",padding:"5px 20px 0px 20px"}}><Link style={{color:"yellow"}} to={`#`}>Help</Link></li>
